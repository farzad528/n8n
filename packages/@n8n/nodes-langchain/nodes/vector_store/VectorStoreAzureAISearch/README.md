...
- **Flexible Query Types**: Vector, keyword, hybrid, and semantic hybrid search
...
- **Results Count**: Number of results to return (default: 50)
- **Filter**: Optional OData filter expression (e.g., `category eq 'technology'`)
- **Semantic Configuration**: Required for semantic hybrid search
...
5. **Batch Size**: Adjust embedding batch size based on your Azure AI Search service tier
